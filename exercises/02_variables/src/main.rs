fn main() {
    ...
    println!();
    println!("基本編：");
    println!("  cargo run --bin ex01_basic");
    println!("  cargo run --bin ex02_shadowing");
    ...
    println!();
    println!("チャレンジ：");
    println!("  cargo run --bin challenge01_bmi");
    println!("  cargo run --bin challenge02_temperature");
